...
/**
  * @author lisha
  * @desc
  * @date 2023/8/23 0023 16:02
  */
public class GeneratorCode {
    public static void main(String[] args) {

        String url = "jdbc:mysql://192.168.1.101:3306/ccii_expert?useUnicode=true&characterEncoding=UTF-8&useSSL=false&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai";
...
//                            .enableSwagger() // 开启 swagger 模式
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("expert"); // 设置需要生成的表名
